...
public class ShopListActivity extends AppCompatActivity {
    ...
    private ArrayList<ProductItem> mItemsData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ProductItemAdapter(this, mItemsData);
    ...
    public void deleteItem(ProductItem item) {
        ...
        ref.delete()
            .addOnSuccessListener(success -> {
                ...
                Toast.makeText(this, "Termék sikeresen törölve", Toast.LENGTH_SHORT).show();
            })
            .addOnFailureListener(fail -> {
                Toast.makeText(this, "Item " + item._getId() + " cannot be deleted.", Toast.LENGTH_LONG).show();
                Toast.makeText(this, "Termék törlése sikertelen", Toast.LENGTH_SHORT).show();
            });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.log_out_button:
                ...
                Toast.makeText(this, "Felhasználó kijelentkezve", Toast.LENGTH_SHORT).show();
